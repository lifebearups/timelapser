   ...
   public int getFrameRate(){ //IN MS
    ...
    private void addListeners() {
        ...
        project_name.getDocument().addDocumentListener(new DocumentListener() {
            ...
            @Override
            public void insertUpdate(DocumentEvent e) {
                con.setProjectName(project_name.getText());
            }
        ...
        ActionListener savebtn = new ActionListener() {
            public void actionPerformed(ActionEvent actionEvent) {
                    ...
                    int result = fc.showOpenDialog(con.gui);
                    if(result == JFileChooser.APPROVE_OPTION){
                        con.savePath(fc.getSelectedFile().getAbsolutePath());
                    }
            }
        };        
    ...
    void updateSaveLocationHint(String location){
